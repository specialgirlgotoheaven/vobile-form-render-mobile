...
var transformProps = function transformProps(props) {
  var schema = props.schema,
    ...
    otherProps = __rest(props, ["schema", "beforeFinish", "onMount", "displayType", "watch", "removeHiddenData", "readOnly", "column", "locale", "configProvider", "validateMessages", "debug", "id", "labelWidth", "maxWidth", "form", "onFinish", "onFinishFailed", "logOnMount", "logOnSubmit", "labelCol", "fieldCol", "className"]);
