...
var FormCore = function FormCore(props) {
  ...
  var isCardMode = useStore(store, function (state) {
    return state.isCardMode;
  });
  var _a = schema || {},
    type = _a.type,
    properties = _a.properties,
    schemaProps = __rest(_a, ["type", "properties"]);
  var _transformProps = transformProps(Object.assign(Object.assign({}, props), schemaProps)),
  ...
  return /*#__PURE__*/React.createElement(_Form, Object.assign({}, formProps, {
    className: classnames('frm-form', className, _defineProperty({}, 'frm-form-card', isCardMode)),
    form: form,
