...
exports.transformRules = exports.default = void 0;
...
var insertLengthRule = function insertLengthRule(schema, rules) {
...
var insertRequiredRule = function insertRequiredRule(schema, rules) {
  var _a;
  var type = schema.type,
    ...
    title = schema.title;
  var requiredAlready = (_a = schema === null || schema === void 0 ? void 0 : schema.rules) === null || _a === void 0 ? void 0 : _a.some(function (item) {
  ...
  if (['year', 'quarter', 'month', 'week', 'date', 'dateTime', 'time'].includes(format) && type === 'range') {
    ...
    rule = {
      ...
      required: true,
      whitespace: true,
      message: (message === null || message === void 0 ? void 0 : message.required) || (!title ? '内容必填' : undefined)
    };
  }
  rules.push(rule);
};
var transformRules = exports.transformRules = function transformRules() {
  ...
  return rules.map(function (item) {
    if (item.validator && !item.transformed) {
      var validator = (0, _utils.isFunction)(item.validator) ? item.validator : methods[item.validator];
...
var _default = exports.default = function _default(_schema, form, methods, fieldRef) {
  var _a, _b;
  var schema = (0, _lodashEs.cloneDeep)(_schema);
      ...
      return (0, _tslib.__awaiter)(void 0, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              if ((0, _utils.isFunction)((_c = fieldRef === null || fieldRef === void 0 ? void 0 : fieldRef.current) === null || _c === void 0 ? void 0 : _c.validator)) {
                _context2.next = 2;
                break;
              }
  ...
  if (format === 'image') {
    rules.push({
      validator: function validator(_, value) {
        ...
        var _isUrl = (0, _utils.isUrl)(value);
  ...
  if (format === 'color') {
    rules.push({
      validator: function validator(_, value) {
        try {
          (0, _color.default)(value || null); // 空字符串无法解析会报错，出现空的情况传 null
          return true;
        } catch (e) {
          return false;
        }
