...
var VirtualList = function VirtualList(props) {
  ...
  var columns = (0, _sortProperties.default)(Object.entries(itemSchema)).map(function (_ref) {
    ...
    return {
      ...
      render: function render(_, field) {
        ...
        return /*#__PURE__*/_react.default.createElement(_virtualCell.default, {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, showTable && ( /*#__PURE__*/_react.default.createElement(_table.default, {
    className: (0, _classnames.default)('fr-virtual-list', {
