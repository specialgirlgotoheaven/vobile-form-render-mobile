...
var _cascader = _interopRequireDefault(require("antd-mobile/es/components/cascader"));
...
var _default = exports.default = function _default(props) {
  var _a = (0, _lodashEs.omit)(props, ['addons', 'schema']),
    ...
    options = _a.options,
    rest = (0, _tslib.__rest)(_a, ["placeholder", "value", "onChange", "options"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_cascader.default, Object.assign({}, rest, {
    ref: pickerRef,
    value: value,
    options: options,
    onConfirm: onChange
