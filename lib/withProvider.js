...
var _configProvider = _interopRequireDefault(require("antd-mobile/es/components/config-provider"));
var _tslib = require("tslib");
var _react = _interopRequireWildcard(require("react"));
var _dayjs = _interopRequireDefault(require("dayjs"));
var _ahooks = require("ahooks");
var _enUS = _interopRequireDefault(require("antd-mobile/es/locales/en-US"));
var _zhCN = _interopRequireDefault(require("antd-mobile/es/locales/zh-CN"));
var _locales = _interopRequireDefault(require("./locales"));
require("dayjs/locale/zh-cn");
var _store = require("./models/store");
var _context = require("./models/context");
var _validateMessage = require("form-render/es/models/validateMessage");
...
function withProvider(Element) {
  return function (props) {
    ...
    var antdLocale = locale === 'zh-CN' ? _zhCN.default : _enUS.default;
